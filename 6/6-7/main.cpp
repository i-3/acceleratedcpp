...
vector<Student_info> didnt_hw(vector<Student_info> &v)
{
    vector<Student_info>::iterator i =
        stable_partition(v.begin(), v.end(), did_all_hw);
    vector<Student_info> vec(i, v.end());
    v.erase(i, v.end());
    return vec;
}
...
int main()
{
    ...
    vector<Student_info> didnt = didnt_hw(did);
